...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '夏夏飞机', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个稳定好用的机场', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'ktnjly.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '翻墙,科技上网,飞机场', // 网站关键词 英文逗号隔开
